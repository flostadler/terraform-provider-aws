		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckOutput("parameter_len", acctest.CtZero),
				),
			},
			{
				ResourceName:      resourceName,
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckDocumentExists(ctx, resourceName),
					resource.TestCheckResourceAttr(resourceName, "document_version", acctest.CtTwo),
					resource.TestCheckResourceAttr(resourceName, "latest_version", acctest.CtTwo),
					resource.TestCheckResourceAttr(resourceName, "default_version", acctest.CtTwo),
					resource.TestCheckOutput("default_version", acctest.CtTwo),
					resource.TestCheckOutput("document_version", acctest.CtTwo),
					resource.TestCheckOutput("hash", "214c51d87f98ae07b868a63cd866955578c1ef41c3ab8c36f80039dfd9565f53"),
					resource.TestCheckOutput("latest_version", acctest.CtTwo),
